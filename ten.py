...
lbl2 = tk.Label(frame2, text = 'Colour,Width - e.g., blue,10')
lbl2.configure(font = ('Comic Sans', 10, 'normal'))
lbl2.configure(anchor = tk.E, justify = tk.LEFT, relief = tk.GROOVE, borderwidth = 2)
lbl2.configure(padx = 10, pady = 5)
